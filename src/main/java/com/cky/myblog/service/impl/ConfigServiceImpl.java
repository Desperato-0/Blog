package com.cky.myblog.service.impl;

import com.cky.myblog.dao.BlogConfigMapper;
import com.cky.myblog.entity.BlogConfig;
import com.cky.myblog.service.ConfigService;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "cky's blog";
    ...
    public static final String yourAvatar = "/admin/dist/img/cky-logo.png";
    public static final String yourEmail = "2907183182@qq.com";
    public static final String yourName = "cky";

    public static final String footerAbout = "Personal Blog";
    public static final String footerICP = "";
    public static final String footerCopyRight = "@2020 CKY";
